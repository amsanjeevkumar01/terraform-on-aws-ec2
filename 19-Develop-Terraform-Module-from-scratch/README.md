...
http://mybucket-1045.s3-website.ap-south-1.amazonaws.com/
```
...
# Replace Values (Bucket Name, Region)
http://mybucket-1046.s3-website.ap-south-1.amazonaws.com/
```
...
# Replace Values (Bucket Name, Region)
http://mybucket-1047.s3-website.ap-south-1.amazonaws.com/
```
